...
export function FloatingActions() {
  return (
    <div className="fixed bottom-4 right-4 z-50 hidden flex-col gap-2.5 md:flex md:bottom-6 md:right-6 md:gap-3">
      {/* WhatsApp */}
      <a
        href={site.whatsapp}
        target="_blank"
        ...
        className="group flex h-11 w-11 items-center justify-center rounded-full bg-[#25D366] text-white shadow-lg shadow-navy-deep/30 transition-transform hover:scale-110 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-[#25D366] sm:h-14 sm:w-14"
      >
        <svg
          viewBox="0 0 24 24"
